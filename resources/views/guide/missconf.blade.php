...
<body>
  ...
  <div class="container-fluid">
    ...
    <!-- Main Content -->
    <div class="content">
      <h1>Security Missconfiguration</h1>
        <p>Security misconfiguration is when a system or application's security settings are incorrect or missing. This can create vulnerabilities that attackers can exploit to gain access to sensitive data. </p>
        <h1>Step</h1>
        <ol>
            <li><p>Enumeration on the host. You can use dirsearch or dir bruteforce tools</p></li>
            <li><p>After that you will found the dir result</p></li>
            <li><img src="{{ asset('Guides/missconfiguration/1.png') }}"></li>
            <li><p>Checking their info</p></li>
            <li><img src="{{ asset('Guides/missconfiguration/2.png') }}"></li>
            <li><p>On this step, we can dump the git</p></li>
            <li><img src="{{ asset('Guides/missconfiguration/3.png') }}"></li>
            <li><p>After that we found the sensitive data information</p></li>
        </ol>
        <h1>CVSS risk rate</h1>
        <p>CVSS:3.1/AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:N/A:N</p>
      <h1>How to Fix</h1>
      <ol>
        <li><p>Do to validate file permission into folder or dir sensitive information</p></li>
        <li><p>Add rule firewall for sensitve file information like .git, .env</p></li>
      </ol>
    </div>
  </div>
